    ...
    <div className='info container section'>
        <div className="infoContainer container">
            <div className="titleDiv flex">
                <h2 data-aos='fade-right' data-aos-duration='2000'>Travel to make memories all around the world</h2> 
            ...
            <div className="cardsDiv grid">
                <div data-aos='fade-up' data-aos-duration='2500' className="singleCard grid">
                    ...
                    <p>You can also call ailines from your phone and book a flight ticket!</p>
                </div>
                ...
                <div data-aos='fade-up' data-aos-duration='2500' className="singleCard grid">
                    ...
                    <p>Make sure all your documents are correct!</p>
                </div>
