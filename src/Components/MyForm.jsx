...
import { isEmail, isNumber, isMaxLength } from "@formiz/validations"; // Import some validations
            ...
            <div className="row">
              <div className="col-1">
                <div className="demo-form-group ">
                  <div className="form-group mt-5">
                    <label className="demo-label form-label"></label>
                  </div>
                </div>
              </div>
              <div className="col-4">
              ...
              <div className="col-4">
                <MyField
                  name={`Flight_ID`}
                  label="Flight_ID"
                  required="Flight_ID is required"
                />
              </div>
              <div className="col-3">
                <MyField
